...
export default class Card {
  constructor(cards, handlePreview, templateData, {handleLikeClick, handleDeleteLikeClick, handleDeleteCard}) {
  ...
  setupLikeCount() { 
    this._element.querySelector('.cards__like-count').textContent = String(this._likes.length)
   } 
